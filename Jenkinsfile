        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'RAG-Medical-Chatbot', url: 'https://github.com/Amitgitup/RAG-Medical-Chatbot.git']])
                }
            }
        }
